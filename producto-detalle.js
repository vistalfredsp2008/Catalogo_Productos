...
// Función para sincronizar la configuración del Panel de Control
function aplicarConfiguracionPersonalizada() {
  // A. Cargar Datos de Contacto y Ubicación
  ...
  if (contactoStr) {
    ...
    // Cargar Mapa de Google desde la configuración guardada
    ...
    if (config.mapaUrl && iframeMapa && colMapa) {
      ...
      colMapa.style.display = "block"; // Hace visible la columna del mapa si hay una URL registrada
    }
  }
